        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            ...
            <p className="mt-5 text-base leading-relaxed text-slate-600">
              Pomagam mieszkańcom <strong>Warszawy, Piaseczna, Serocka i okolic</strong> w doborze i montażu klimatyzacji od podstaw. Bez stresu, bez ukrytych kosztów, bez czekania tygodniami na wycenę.
            </p>
